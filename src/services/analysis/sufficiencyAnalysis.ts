...
export async function analyzeTOSSufficiency(tosMatrix: any) {
  ...
  // 1️⃣ Fetch all approved & usable questions
  ...
  const recommendations =
    totalRequired - totalAvailable > 0
      ? [`AI will generate ${totalRequired - totalAvailable} additional questions to meet TOS requirements.`]
      : ["All required questions already exist in the bank."];
